  ...
  return (
    <div className="centered-section" style={{ height: 'auto', padding: '5vh 1vw' }}>
      <div className="card simple-card" style={{ height: 'auto', textAlign: 'left', padding: '3vh 2vw', maxWidth: '80vw', marginBottom: '3vh' }}>
        <h1 style={{ margin: '0 0 2vh 0', textAlign: 'center', fontSize: '4vh' }}>Get In Touch</h1>
        <div className="card-divider"></div>

        <div className="contact-content-simple">
          <div className="contact-info">
            <h2>Let's Talk</h2>
            <p>I'm always interested in hearing about new projects and opportunities. Feel free to reach out if you have any questions or would like to collaborate.</p>
            <h3 style={{ marginTop: '3vh', marginBottom: '1vh', fontFamily: "'Consolas', monospace", color: '#333' }}>Contact Details</h3>
            <p>
              <b>Yasith Silva</b><br />
              <a href="mailto:yasithudana3@gmail.com">yasithudana3@gmail.com</a><br />
              <a href="tel:+94711495119">+94 71 149 5119</a>
            </p>
          </div>

          <div className="social-buttons">
            <a href="https://www.linkedin.com/in/yasithsilva/" target="_blank" rel="noopener noreferrer" className="social-button">
              <svg style={{ width: '4vh', height: '4vh' }} fill="#414243" viewBox="0 0 24 24">
            ...
            <a href="https://github.com/yasith46" target="_blank" rel="noopener noreferrer" className="social-button">
              <svg style={{ width: '4vh', height: '4vh' }} fill="#414243" viewBox="0 0 24 24">
            ...
            <a href="https://medium.com/@yasithudana3" target="_blank" rel="noopener noreferrer" className="social-button">
              <svg style={{ width: '4vh', height: '4vh' }} fill="#414243" viewBox="0 0 24 24">
            ...
            <a href="https://www.youtube.com/@yasithsilva5513" target="_blank" rel="noopener noreferrer" className="social-button">
              <svg style={{ width: '4vh', height: '4vh' }} fill="#414243" viewBox="0 0 34.28 24">
            ...
            <a href="mailto:yasithudana3@gmail.com" className="social-button">
              <svg style={{ width: '4vh', height: '4vh' }} fill="#414243" viewBox="0 0 30 24">
